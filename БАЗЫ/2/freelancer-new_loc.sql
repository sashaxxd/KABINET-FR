...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 01 2018 г., 22:29
...
(49, 'Павел', 'Фалейчик', 'ttt', '2017-12-30', '0'),
...
(22, 'Петя', 'Петров', '0', '23', 'pes', '2017-12-13', 'Конь'),
...
(1, 'Программист на Java и PHP с почасовой оплатой', '0', 'Нужен рукастый программист с опытом работы с javascript и php. Работаем через teamviewer, оплата - 1000 в час. Подробности через скайп matoringleb@gmail.com', 5000, '0', '2018-02-01', '10:21:23', 0, 49),
(2, 'sdfsdf', '0', 'saassasdfsdfsdf', 4444, '0', '2018-02-01', '14:20:59', 0, 49),
(3, 'efef', '0', 'sdfsfdsf', 456, '0', '2018-02-01', '15:34:45', 0, 49),
(4, 'Я туко всех порву', '0', 'sdfsfdsf', 456, '0', '2018-02-01', '15:35:32', 0, 49),
(5, '333 Задание', '0', 'ыва', 23, '1', '2018-02-01', '15:44:10', 1, 55),
(6, 'asasas', '2', 'assaas', 333, '0', '2018-02-01', '16:07:36', 0, 49),
(7, 'asasas', '2', 'assaas', 333, '0', '2018-02-01', '16:08:42', 0, 49),
(8, 'asasas', 'Графический дизайн', 'assaas', 333, '0', '2018-02-01', '16:13:40', 0, 49),
(9, 'sdassa', '8', 'asasassa', 123, '1', '2018-02-01', '16:14:42', 0, 49),
(10, 'as', 'Реклама / презентации', 'asasas', 222, '1', '2018-02-01', '16:15:06', 0, 49),
(11, 'Давно выяснено, что при оценке дизайна и композиции читаемый текст мешает ', 'Фирменный стиль', 'Давно выяснено, что при оценке дизайна и композиции читаемый текст мешает сосредоточиться. Lorem Ipsum используют потому, что тот обеспечивает более или менее стандартное заполнение шаблона, а также реальное распределение букв и пробелов в абзацах, которое не получается при простой дубликации \"Здесь ваш текст.. Здесь ваш текст.. Здесь ваш текст..\" Многие программы электронной вёрстки и редакторы HTML используют Lorem Ipsum в качестве текста по умолчанию, так что поиск по ключевым словам \"lorem ipsum\" сразу показывает, как много веб-страниц всё ещё дожидаются своего настоящего рождения. За прошедшие годы текст Lorem Ipsum получил много версий. Некоторые версии появились по ошибке, некоторые - намеренно (например, юмористические варианты).', 2321, '0', '2018-02-01', '16:19:03', 0, 49),
(12, 'Давно выяснено, что при оценке дизайна и композиции читаемый текст мешает ', 'Арт / иллюстрации', 'Давно выяснено, что при оДавно выяснено, что при оценке дизайна и композиции читаемый текст мешает сосредоточиться. Lorem Ipsum используют потому, что тот обеспечивает более или менее стандартное заполнение шаблона, а также реальное распределение букв и пробелов в абзацах, которое не получается при простой дубликации \"Здесь ваш текст.. Здесь ваш текст.. Здесь ваш текст..\" Многие программы электронной вёрстки и редакторы HTML используют Lorem Ipsum в качестве текста по умолчанию, так что поиск по ключевым словам \"lorem ipsum\" сразу показывает, как много веб-страниц всё ещё дожидаются своего настоящего рождения. За прошедшие годы текст Lorem Ipsum получил много версий. Некоторые версии появились по ошибке, некоторые - намеренно (например, юмористические варианты).ценке дизайна и композиции читаемый текст мешает ', 322, '1', '2018-02-01', '16:19:42', 0, 49),
(13, 'ывфафа', 'Менеджмент', 'ыфа', 234324, '1', '2018-02-01', '16:56:15', 0, 49),
(14, 'ыаыа', '3D графика', 'ыфава', 234234, '0', '2018-02-01', '16:56:32', 1, 49),
(15, 'ыаыа', 'Флеш', 'аыва', 234234, '1', '2018-02-01', '16:56:48', 1, 49);
